...
(function($PS) {
  ...
  var mouseMove = MouseMove.create;
  var interpreter = Spork_Interpreter.Interpreter(Spork_EventQueue.withAccumArray(Effect.applicativeEffect)(function (queue) {
      return function __do() {
          ...
          var listener = Web_Event_EventTarget.eventListener(function (event) {
              return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Web_UIEvent_MouseEvent.fromEvent(event))(function (mouseEvent) {
                  var coord = {
                      x: Web_UIEvent_MouseEvent.clientX(mouseEvent),
                      y: Web_UIEvent_MouseEvent.clientY(mouseEvent)
                  };
                  return function __do() {
                      Control_Bind.bind(Effect.bindEffect)(Effect_Ref.read(model))(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(function (v) {
                          return queue.push(v.value0(coord));
                      }))();
                      return queue.run();
                  };
              });
          ...
          var commit = function ($$new) {
              return function __do() {
                  ...
                  if ($$new.length === 0) {
                      return Web_Event_EventTarget.removeEventListener(Web_UIEvent_MouseEvent_EventTypes.mousemove)(listener)(false)(win)();
                  };
                  if (old.length === 0) {
                      return Web_Event_EventTarget.addEventListener(Web_UIEvent_MouseEvent_EventTypes.mousemove)(listener)(false)(win)();
                  };
                  return Data_Unit.unit;
              };
          };
...
(function($PS) {
  ...
  var UpdateSub = (function () {
      function UpdateSub(value0) {
          this.value0 = value0;
      };
      UpdateSub.create = function (value0) {
          return new UpdateSub(value0);
      };
      return UpdateSub;
  })();
  var UpdateCoord = (function () {
      function UpdateCoord(value0) {
          this.value0 = value0;
      };
      UpdateCoord.create = function (value0) {
          return new UpdateCoord(value0);
      };
      return UpdateCoord;
  })();
  var update = function (model) {
      return function (v) {
          if (v instanceof UpdateSub) {
              return Spork_Transition.purely({
                  subscribing: v.value0,
                  coord: Data_Maybe.Nothing.value
              });
          };
          if (v instanceof UpdateCoord) {
              return Spork_Transition.purely({
                  coord: new Data_Maybe.Just(v.value0),
                  subscribing: model.subscribing
              });
          };
          throw new Error("Failed pattern match at Main (line 31, column 16 - line 39, column 46): " + [ v.constructor.name ]);
      };
  };
  var subs = function (v) {
      if (v.subscribing) {
          return Spork_Batch.lift(Subs.mouseMove(UpdateCoord.create));
      };
      if (Data_Boolean.otherwise) {
          return Data_Monoid.mempty(Spork_Batch.monoidBatch);
      };
      throw new Error("Failed pattern match at Main (line 66, column 1 - line 66, column 36): " + [ v.constructor.name ]);
  };
  var renderCoord = function (v) {
      return "(" + (Data_Show.show(Data_Show.showInt)(v.x) + (", " + (Data_Show.show(Data_Show.showInt)(v.y) + ")")));
  };
  var render = function (v) {
      return Spork_Html_Elements.div([ Spork_Html_Properties.classes([ "wrapper" ]) ])([ Spork_Html_Elements.button([ Spork_Html_Properties.type_(Spork_Html_Core.buttonTypeToPropValue)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Spork_Html_Events.onClick(Spork_Html_Events.always_(new UpdateSub(!v.subscribing))) ])([ Spork_Html_Core.text((function () {
          if (v.subscribing) {
              return "Unsubscribe";
          };
          return "Track the Pointer";
      })()) ]), Spork_Html_Elements.span([ Spork_Html_Properties.classes([ Data_Monoid.guard(Data_Monoid.monoidString)(v.subscribing)("subscribing") ]) ])([ Spork_Html_Core.text((function () {
          if (v.subscribing) {
              return Data_Maybe.maybe("Move the pointer")(renderCoord)(v.coord);
          };
          return "hello";
      })()) ]) ]);
  };
  ...
  var main = function __do() {
      var inst = Spork_App.makeWithSelector(Spork_Interpreter.merge(Effect.applicativeEffect)(Spork_Interpreter.never(Effect.monadEffect))(Subs.interpreter))(app)("#app")();
      return inst.run();
  };
  exports["initialModel"] = initialModel;
  exports["UpdateSub"] = UpdateSub;
  exports["UpdateCoord"] = UpdateCoord;
  exports["update"] = update;
  exports["render"] = render;
  exports["renderCoord"] = renderCoord;
  exports["subs"] = subs;
  exports["app"] = app;
  exports["main"] = main;
})(PS);
